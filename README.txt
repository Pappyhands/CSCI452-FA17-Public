...
[COMPLETE] VS1 - As an unauthenticated or authenticated user, I want to be able to view a list of snippet summaries that contain the creator, language, and snippet description so that I can use them when I am writing code.
[COMPLETE] VS2 - As an unauthenticated or authenticated user, I want to be able to filter or sort a list of snippets by creator, language, or description.
[COMPLETE] VS3 - As an unauthenticated or authenticated user, I want to be able to select a snippet in the list and view the code associated with the snippet.
...
[COMPLETE] UA5 - As an authenticated user, I want to be able to logout of my account.

Release 3 - Snippet Management (SM)
[COMPLETE] SM1 - As an authenticated user I want to be able to be able to create a new snippet and specify the snippet's language, description, and code.
[COMPLETE] SM2 - As an authenticated user I want to be able to be able to select from a list of predefined languages when associating a language with a new snippet.
[COMPLETE] SM3 - As an authenticated user I want to be able to be able to delete or edit snippets that I have created.
[COMPLETE] SM4 - As an authenticated user I want to be sure that other users cannot delete or edit snippets that I have created.